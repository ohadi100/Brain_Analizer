...
#ifndef INC_VWG_SERVICES_SECURITY_IDSPREMIUMSERVICES_IDSCANSENSOR_IDSCANSENSOR_SKELETON_FIELDS_H
#define INC_VWG_SERVICES_SECURITY_IDSPREMIUMSERVICES_IDSCANSENSOR_IDSCANSENSOR_SKELETON_FIELDS_H
        ...
        namespace idscansensor
        {
          ...
          namespace skeleton
          {
            ...
            namespace fields
            {
              ...
              : public Field_value<IdsCanSensor::Fields::canSensorFeaturesElement0>
              , public Field_get<IdsCanSensor::Fields::canSensorFeaturesElement0>
              , private Field_notify<IdsCanSensor::Fields::canSensorFeaturesElement0>
              {
                public:
                ...
                canSensorFeaturesElement0(Method_dispatcher& method_dispatcher, Field_validator& field_validator);
              };

              class periodicSignalElement0
              : public Field_value<IdsCanSensor::Fields::periodicSignalElement0>
              , public Field_get<IdsCanSensor::Fields::periodicSignalElement0>
              , private Field_notify<IdsCanSensor::Fields::periodicSignalElement0>
              {
                public:
