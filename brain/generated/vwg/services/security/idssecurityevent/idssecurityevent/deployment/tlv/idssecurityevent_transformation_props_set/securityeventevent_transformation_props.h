...
#ifndef INC_VWG_SERVICES_SECURITY_IDSSECURITYEVENT_IDSSECURITYEVENT_DEPLOYMENT_TLV_IDSSECURITYEVENT_TRANSFORMATION_PROPS_SET_SECURITYEVENTEVENT_TRANSFORMATION_PROPS_H
#define INC_VWG_SERVICES_SECURITY_IDSSECURITYEVENT_IDSSECURITYEVENT_DEPLOYMENT_TLV_IDSSECURITYEVENT_TRANSFORMATION_PROPS_SET_SECURITYEVENTEVENT_TRANSFORMATION_PROPS_H
          ...
          namespace deployment
          {
            namespace tlv
            {
              namespace idssecurityevent_transformation_props_set
              {
                ...
                securityEventEvent_transformation_props
                {
                  0, // Alignment
