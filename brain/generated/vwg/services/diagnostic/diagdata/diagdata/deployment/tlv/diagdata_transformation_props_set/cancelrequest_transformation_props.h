...
#ifndef INC_VWG_SERVICES_DIAGNOSTIC_DIAGDATA_DIAGDATA_DEPLOYMENT_TLV_DIAGDATA_TRANSFORMATION_PROPS_SET_CANCELREQUEST_TRANSFORMATION_PROPS_H
#define INC_VWG_SERVICES_DIAGNOSTIC_DIAGDATA_DIAGDATA_DEPLOYMENT_TLV_DIAGDATA_TRANSFORMATION_PROPS_SET_CANCELREQUEST_TRANSFORMATION_PROPS_H
          ...
          namespace deployment
          {
            namespace tlv
            {
              namespace diagdata_transformation_props_set
              {
                ...
                cancelRequest_transformation_props
                {
                  0, // Alignment
