...
#ifndef INC_VWG_SERVICES_CONNECT_DATACOLLECTOR_ODCAGENTCOMMONLARGE_DEPLOYMENT_TLV_ODCAGENTCOMMONLARGE_TRANSFORMATION_PROPS_SET_ADDCAMPAIGN_TRANSFORMATION_PROPS_H
#define INC_VWG_SERVICES_CONNECT_DATACOLLECTOR_ODCAGENTCOMMONLARGE_DEPLOYMENT_TLV_ODCAGENTCOMMONLARGE_TRANSFORMATION_PROPS_SET_ADDCAMPAIGN_TRANSFORMATION_PROPS_H
          ...
          namespace deployment
          {
            namespace tlv
            {
              namespace odcagentcommonlarge_transformation_props_set
              {
                ...
                addCampaign_transformation_props
                {
                  0, // Alignment
