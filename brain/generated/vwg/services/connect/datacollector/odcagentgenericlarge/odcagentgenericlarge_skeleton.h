...
#ifndef INC_VWG_SERVICES_CONNECT_DATACOLLECTOR_ODCAGENTGENERICLARGE_ODCAGENTGENERICLARGE_SKELETON_H
#define INC_VWG_SERVICES_CONNECT_DATACOLLECTOR_ODCAGENTGENERICLARGE_ODCAGENTGENERICLARGE_SKELETON_H
      ...
      namespace datacollector
      {
        ...
        namespace odcagentgenericlarge
        {
          ...
          namespace skeleton
          {
            namespace events
            {
              using data = ::ac::com::cpp_binding::skeleton::Event<::vwg::services::connect::datacollector::odcagentgenericlarge::OdcAgentGenericLarge::Events::data>;
            } // namespace events

            namespace methods
            {
              using control = ::ac::com::cpp_binding::skeleton::FireAndForgetMethod<::vwg::services::connect::datacollector::odcagentgenericlarge::OdcAgentGenericLarge::Methods::control>;
            } // namespace methods

            class OdcAgentGenericLargeSkeleton
            : public ::ac::com::cpp_binding::skeleton::Skeleton<OdcAgentGenericLarge>
            {
              public:
              ...
              explicit OdcAgentGenericLargeSkeleton(
              ...
              explicit OdcAgentGenericLargeSkeleton(ConstructionToken&& token) noexcept;

              virtual void
              control(::vwg::services::connect::datacollector::odcagentgenericlarge::ControlInfo const& controlInfo) = 0;
