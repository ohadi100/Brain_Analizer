...
#ifndef INC_VWG_SERVICES_CONNECT_DATACOLLECTOR_ODCAGENTGENERICLARGE_ODCAGENTGENERICLARGE_COMMON_H
#define INC_VWG_SERVICES_CONNECT_DATACOLLECTOR_ODCAGENTGENERICLARGE_ODCAGENTGENERICLARGE_COMMON_H
...
#include "vwg/services/connect/datacollector/odcagentgenericlarge/odcagentgenericlarge_types.h"
    ...
    namespace connect
    {
      ...
      namespace datacollector
      {
        ...
        namespace odcagentgenericlarge
        {
          ...
          class OdcAgentGenericLarge
          {
            public:
            static constexpr ::ara::com::ServiceIdentifierType id()
            { return ::ara::com::ServiceIdentifierType("vwg::services::connect::datacollector::odcagentgenericlarge::OdcAgentGenericLarge"); }
            ...
            struct Events
            {
              struct data
              {
                ...
                using SampleType = ::vwg::services::connect::datacollector::odcagentgenericlarge::OdcAgentGenericLarge_data_eventData;
            ...
            struct Methods
            {
              struct control
              {
                ...
                using Signature = void(::vwg::services::connect::datacollector::odcagentgenericlarge::ControlInfo const&);
