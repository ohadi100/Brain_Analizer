...
#ifndef INC_VWG_SERVICES_CONNECT_GSDP_HEALTHINCIDENTPROVIDER_DEPLOYMENT_TLV_HEALTHINCIDENTPROVIDER_TRANSFORMATION_PROPS_SET_GETLASTINCIDENTS_TRANSFORMATION_PROPS_H
#define INC_VWG_SERVICES_CONNECT_GSDP_HEALTHINCIDENTPROVIDER_DEPLOYMENT_TLV_HEALTHINCIDENTPROVIDER_TRANSFORMATION_PROPS_SET_GETLASTINCIDENTS_TRANSFORMATION_PROPS_H
          ...
          namespace deployment
          {
            namespace tlv
            {
              namespace healthincidentprovider_transformation_props_set
              {
                ...
                getLastIncidents_transformation_props
                {
                  0, // Alignment
