...
#ifndef VWG_SERVICES_IDSIPSECURITYSENSOR_IDSIPSECURITYSENSOR_COMMON_H
#define VWG_SERVICES_IDSIPSECURITYSENSOR_IDSIPSECURITYSENSOR_COMMON_H

#include "ara/com/types.h"
#include "idsipsecuritysensor_types.h"
// -- Service namespace
namespace vwg
{
  ...
  namespace services
  {
    ...
    namespace idsipsecuritysensor
    {
      ...
      class IDSIpSecuritySensor
      {
        public:
        static constexpr ::ara::com::ServiceIdentifierType id()
        { return ::ara::com::ServiceIdentifierType("vwg::services::idsipsecuritysensor::IDSIpSecuritySensor"); }
        ...
        struct firewallFilterReports
        {
          using FieldType = ::vwg::services::idsipsecuritysensor::datatypes::DT_firewallFilterReports_vector;
          struct Notify
          {
