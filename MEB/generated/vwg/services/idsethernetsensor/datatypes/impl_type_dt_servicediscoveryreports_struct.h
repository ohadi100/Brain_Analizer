...
#ifndef VWG_SERVICES_IDSETHERNETSENSOR_DATATYPES_IMPL_TYPE_DT_SERVICEDISCOVERYREPORTS_STRUCT_H
#define VWG_SERVICES_IDSETHERNETSENSOR_DATATYPES_IMPL_TYPE_DT_SERVICEDISCOVERYREPORTS_STRUCT_H
...
#include "vwg/services/idsethernetsensor/datatypes/impl_type_dt_servicediscoveryreportsframepayload.h"
...
namespace vwg
{
  namespace services
  {
    namespace idsethernetsensor
    {
      namespace datatypes
      {
        struct DT_serviceDiscoveryReports_struct
        {
          ...
          ::ara::com::Optional<DT_serviceDiscoveryReportsframePayload> framePayload;
