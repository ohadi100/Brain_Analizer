...
#ifndef VWG_SERVICES_IDSETHERNETSENSOR_DATATYPES_IMPL_TYPE_DT_SPECIALFRAMEREPORTS_STRUCT_H
#define VWG_SERVICES_IDSETHERNETSENSOR_DATATYPES_IMPL_TYPE_DT_SPECIALFRAMEREPORTS_STRUCT_H
...
#include "vwg/services/idsethernetsensor/datatypes/impl_type_dt_specialframereportsframepayload.h"
#include "vwg/services/idsethernetsensor/datatypes/impl_type_dt_idsethernetsensor_specialframereports_frametype.h"
...
namespace vwg
{
  namespace services
  {
    namespace idsethernetsensor
    {
      namespace datatypes
      {
        struct DT_specialFrameReports_struct
        {
          ...
          ::ara::com::Optional<DT_specialFrameReportsframePayload> framePayload;
          ::ara::com::Optional<DT_IDSEthernetSensor_specialFrameReports_frameType> frameType;
