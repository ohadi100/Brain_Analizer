...
#ifndef VWG_SERVICES_DIAG_D_2D92_DATAIDENTIFIER_INTRUSIONDETECTIONSYSTEMTIMINGABNORMALEVENT_COMMON_H
#define VWG_SERVICES_DIAG_D_2D92_DATAIDENTIFIER_INTRUSIONDETECTIONSYSTEMTIMINGABNORMALEVENT_COMMON_H

#include "ara/com/types.h"
#include "dataidentifier_intrusiondetectionsystemtimingabnormalevent_types.h"
// -- Service namespace
namespace vwg
{
  ...
  namespace services
  {
    ...
    namespace diag
    {
      ...
      namespace d_2d92
      {
        ...
        class DataIdentifier_IntrusionDetectionSystemTimingAbnormalEvent
        {
          public:
          static constexpr ::ara::com::ServiceIdentifierType id()
          { return ::ara::com::ServiceIdentifierType("vwg::services::diag::d_2d92::DataIdentifier_IntrusionDetectionSystemTimingAbnormalEvent"); }
          ...
          class UDSServiceFailed : public ::ara::com::ApplicationErrorException
          {
            ...
            {
              return "DataIdentifier_IntrusionDetectionSystemTimingAbnormalEvent::UDSServiceFailed::2";
            }
        ...
        struct DataIdentifier_IntrusionDetectionSystemTimingAbnormalEvent::Read::Output
        {
        ...
        {
          using UDSServiceFailed = DataIdentifier_IntrusionDetectionSystemTimingAbnormalEvent::UDSServiceFailed;
        }
