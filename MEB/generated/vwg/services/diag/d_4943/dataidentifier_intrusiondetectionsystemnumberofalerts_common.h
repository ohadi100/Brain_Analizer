...
#ifndef VWG_SERVICES_DIAG_D_4943_DATAIDENTIFIER_INTRUSIONDETECTIONSYSTEMNUMBEROFALERTS_COMMON_H
#define VWG_SERVICES_DIAG_D_4943_DATAIDENTIFIER_INTRUSIONDETECTIONSYSTEMNUMBEROFALERTS_COMMON_H

#include "ara/com/types.h"
#include "dataidentifier_intrusiondetectionsystemnumberofalerts_types.h"
// -- Service namespace
namespace vwg
{
  ...
  namespace services
  {
    ...
    namespace diag
    {
      ...
      namespace d_4943
      {
        ...
        class DataIdentifier_IntrusionDetectionSystemNumberOfAlerts
        {
          public:
          static constexpr ::ara::com::ServiceIdentifierType id()
          { return ::ara::com::ServiceIdentifierType("vwg::services::diag::d_4943::DataIdentifier_IntrusionDetectionSystemNumberOfAlerts"); }
          ...
          class UDSServiceFailed : public ::ara::com::ApplicationErrorException
          {
            ...
            {
              return "DataIdentifier_IntrusionDetectionSystemNumberOfAlerts::UDSServiceFailed::2";
            }
        ...
        struct DataIdentifier_IntrusionDetectionSystemNumberOfAlerts::Read::Output
        {
        ...
        {
          using UDSServiceFailed = DataIdentifier_IntrusionDetectionSystemNumberOfAlerts::UDSServiceFailed;
        }
