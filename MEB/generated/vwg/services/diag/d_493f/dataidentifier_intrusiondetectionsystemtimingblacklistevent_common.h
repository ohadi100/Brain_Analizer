...
#ifndef VWG_SERVICES_DIAG_D_493F_DATAIDENTIFIER_INTRUSIONDETECTIONSYSTEMTIMINGBLACKLISTEVENT_COMMON_H
#define VWG_SERVICES_DIAG_D_493F_DATAIDENTIFIER_INTRUSIONDETECTIONSYSTEMTIMINGBLACKLISTEVENT_COMMON_H

#include "ara/com/types.h"
#include "dataidentifier_intrusiondetectionsystemtimingblacklistevent_types.h"
// -- Service namespace
namespace vwg
{
  ...
  namespace services
  {
    ...
    namespace diag
    {
      ...
      namespace d_493f
      {
        ...
        class DataIdentifier_IntrusionDetectionSystemTimingBlacklistEvent
        {
          public:
          static constexpr ::ara::com::ServiceIdentifierType id()
          { return ::ara::com::ServiceIdentifierType("vwg::services::diag::d_493f::DataIdentifier_IntrusionDetectionSystemTimingBlacklistEvent"); }
          ...
          class UDSServiceFailed : public ::ara::com::ApplicationErrorException
          {
            ...
            {
              return "DataIdentifier_IntrusionDetectionSystemTimingBlacklistEvent::UDSServiceFailed::2";
            }
        ...
        struct DataIdentifier_IntrusionDetectionSystemTimingBlacklistEvent::Read::Output
        {
          ::ara::stdtypes::UInt32 dataRecord_abnormal_can_id;
          ::ara::stdtypes::UInt32 dataRecord_number_of_events;
          using Generated_tag = void;
          template<typename F> void visit(F& f)
          {
            f(this->dataRecord_abnormal_can_id);
        ...
        {
          using UDSServiceFailed = DataIdentifier_IntrusionDetectionSystemTimingBlacklistEvent::UDSServiceFailed;
        }
