...
#ifndef VWG_SERVICES_DIAG_D_4942_DATAIDENTIFIER_INTRUSIONDETECTIONSYSTEMTIMINGICAS1ANOMALIES_COMMON_H
#define VWG_SERVICES_DIAG_D_4942_DATAIDENTIFIER_INTRUSIONDETECTIONSYSTEMTIMINGICAS1ANOMALIES_COMMON_H

#include "ara/com/types.h"
#include "dataidentifier_intrusiondetectionsystemtimingicas1anomalies_types.h"
// -- Service namespace
namespace vwg
{
  ...
  namespace services
  {
    ...
    namespace diag
    {
      ...
      namespace d_4942
      {
        ...
        class DataIdentifier_IntrusionDetectionSystemTimingICAS1Anomalies
        {
          public:
          static constexpr ::ara::com::ServiceIdentifierType id()
          { return ::ara::com::ServiceIdentifierType("vwg::services::diag::d_4942::DataIdentifier_IntrusionDetectionSystemTimingICAS1Anomalies"); }
          ...
          class UDSServiceFailed : public ::ara::com::ApplicationErrorException
          {
            ...
            {
              return "DataIdentifier_IntrusionDetectionSystemTimingICAS1Anomalies::UDSServiceFailed::2";
            }
        ...
        struct DataIdentifier_IntrusionDetectionSystemTimingICAS1Anomalies::Read::Output
        {
        ...
        {
          using UDSServiceFailed = DataIdentifier_IntrusionDetectionSystemTimingICAS1Anomalies::UDSServiceFailed;
        }
