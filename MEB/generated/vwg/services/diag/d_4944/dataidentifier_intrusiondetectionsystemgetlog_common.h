...
#ifndef VWG_SERVICES_DIAG_D_4944_DATAIDENTIFIER_INTRUSIONDETECTIONSYSTEMGETLOG_COMMON_H
#define VWG_SERVICES_DIAG_D_4944_DATAIDENTIFIER_INTRUSIONDETECTIONSYSTEMGETLOG_COMMON_H

#include "ara/com/types.h"
#include "dataidentifier_intrusiondetectionsystemgetlog_types.h"
// -- Service namespace
namespace vwg
{
  ...
  namespace services
  {
    ...
    namespace diag
    {
      ...
      namespace d_4944
      {
        ...
        class DataIdentifier_IntrusionDetectionSystemGetLog
        {
          public:
          static constexpr ::ara::com::ServiceIdentifierType id()
          { return ::ara::com::ServiceIdentifierType("vwg::services::diag::d_4944::DataIdentifier_IntrusionDetectionSystemGetLog"); }
          ...
          class UDSServiceFailed : public ::ara::com::ApplicationErrorException
          {
            ...
            {
              return "DataIdentifier_IntrusionDetectionSystemGetLog::UDSServiceFailed::2";
            }
        ...
        struct DataIdentifier_IntrusionDetectionSystemGetLog::Read::Output
        {
          ::vwg::services::diag::datatypes::fixed_size_array_with_64_uint8_items dataRecord_Intrusion_detection_system_get_log;
          using Generated_tag = void;
          template<typename F> void visit(F& f)
          {
            f(this->dataRecord_Intrusion_detection_system_get_log);
          }
        };

        namespace application_errors
        {
          using UDSServiceFailed = DataIdentifier_IntrusionDetectionSystemGetLog::UDSServiceFailed;
        }
