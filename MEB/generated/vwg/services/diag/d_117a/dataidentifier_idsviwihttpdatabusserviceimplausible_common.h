...
#ifndef VWG_SERVICES_DIAG_D_117A_DATAIDENTIFIER_IDSVIWIHTTPDATABUSSERVICEIMPLAUSIBLE_COMMON_H
#define VWG_SERVICES_DIAG_D_117A_DATAIDENTIFIER_IDSVIWIHTTPDATABUSSERVICEIMPLAUSIBLE_COMMON_H

#include "ara/com/types.h"
#include "dataidentifier_idsviwihttpdatabusserviceimplausible_types.h"
// -- Service namespace
namespace vwg
{
  ...
  namespace services
  {
    ...
    namespace diag
    {
      ...
      namespace d_117a
      {
        ...
        class DataIdentifier_IDSViwiHttpDataBusServiceImplausible
        {
          public:
          static constexpr ::ara::com::ServiceIdentifierType id()
          { return ::ara::com::ServiceIdentifierType("vwg::services::diag::d_117a::DataIdentifier_IDSViwiHttpDataBusServiceImplausible"); }
          ...
          class UDSServiceFailed : public ::ara::com::ApplicationErrorException
          {
            ...
            {
              return "DataIdentifier_IDSViwiHttpDataBusServiceImplausible::UDSServiceFailed::2";
            }
        ...
        struct DataIdentifier_IDSViwiHttpDataBusServiceImplausible::Read::Output
        {
        ...
        {
          using UDSServiceFailed = DataIdentifier_IDSViwiHttpDataBusServiceImplausible::UDSServiceFailed;
        }
