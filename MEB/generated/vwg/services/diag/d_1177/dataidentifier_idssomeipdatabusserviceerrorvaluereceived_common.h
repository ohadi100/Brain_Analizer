...
#ifndef VWG_SERVICES_DIAG_D_1177_DATAIDENTIFIER_IDSSOMEIPDATABUSSERVICEERRORVALUERECEIVED_COMMON_H
#define VWG_SERVICES_DIAG_D_1177_DATAIDENTIFIER_IDSSOMEIPDATABUSSERVICEERRORVALUERECEIVED_COMMON_H

#include "ara/com/types.h"
#include "dataidentifier_idssomeipdatabusserviceerrorvaluereceived_types.h"
// -- Service namespace
namespace vwg
{
  ...
  namespace services
  {
    ...
    namespace diag
    {
      ...
      namespace d_1177
      {
        ...
        class DataIdentifier_IDSSomeipDataBusServiceErrorValueReceived
        {
          public:
          static constexpr ::ara::com::ServiceIdentifierType id()
          { return ::ara::com::ServiceIdentifierType("vwg::services::diag::d_1177::DataIdentifier_IDSSomeipDataBusServiceErrorValueReceived"); }
          ...
          class UDSServiceFailed : public ::ara::com::ApplicationErrorException
          {
            ...
            {
              return "DataIdentifier_IDSSomeipDataBusServiceErrorValueReceived::UDSServiceFailed::2";
            }
        ...
        struct DataIdentifier_IDSSomeipDataBusServiceErrorValueReceived::Read::Output
        {
        ...
        {
          using UDSServiceFailed = DataIdentifier_IDSSomeipDataBusServiceErrorValueReceived::UDSServiceFailed;
        }
