...
#ifndef VWG_SERVICES_DIAG_D_493E_DATAIDENTIFIER_INTRUSIONDETECTIONSYSTEMWHITELISTEVENT_COMMON_H
#define VWG_SERVICES_DIAG_D_493E_DATAIDENTIFIER_INTRUSIONDETECTIONSYSTEMWHITELISTEVENT_COMMON_H

#include "ara/com/types.h"
#include "dataidentifier_intrusiondetectionsystemwhitelistevent_types.h"
// -- Service namespace
namespace vwg
{
  ...
  namespace services
  {
    ...
    namespace diag
    {
      ...
      namespace d_493e
      {
        ...
        class DataIdentifier_IntrusionDetectionSystemWhitelistEvent
        {
          public:
          static constexpr ::ara::com::ServiceIdentifierType id()
          { return ::ara::com::ServiceIdentifierType("vwg::services::diag::d_493e::DataIdentifier_IntrusionDetectionSystemWhitelistEvent"); }
          ...
          class UDSServiceFailed : public ::ara::com::ApplicationErrorException
          {
            ...
            {
              return "DataIdentifier_IntrusionDetectionSystemWhitelistEvent::UDSServiceFailed::2";
            }
        ...
        struct DataIdentifier_IntrusionDetectionSystemWhitelistEvent::Read::Output
        {
        ...
        {
          using UDSServiceFailed = DataIdentifier_IntrusionDetectionSystemWhitelistEvent::UDSServiceFailed;
        }
