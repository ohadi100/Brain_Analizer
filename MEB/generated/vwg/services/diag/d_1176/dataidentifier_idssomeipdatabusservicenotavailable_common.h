...
#ifndef VWG_SERVICES_DIAG_D_1176_DATAIDENTIFIER_IDSSOMEIPDATABUSSERVICENOTAVAILABLE_COMMON_H
#define VWG_SERVICES_DIAG_D_1176_DATAIDENTIFIER_IDSSOMEIPDATABUSSERVICENOTAVAILABLE_COMMON_H

#include "ara/com/types.h"
#include "dataidentifier_idssomeipdatabusservicenotavailable_types.h"
// -- Service namespace
namespace vwg
{
  ...
  namespace services
  {
    ...
    namespace diag
    {
      ...
      namespace d_1176
      {
        ...
        class DataIdentifier_IDSSomeipDataBusServiceNotAvailable
        {
          public:
          static constexpr ::ara::com::ServiceIdentifierType id()
          { return ::ara::com::ServiceIdentifierType("vwg::services::diag::d_1176::DataIdentifier_IDSSomeipDataBusServiceNotAvailable"); }
          ...
          class UDSServiceFailed : public ::ara::com::ApplicationErrorException
          {
            ...
            {
              return "DataIdentifier_IDSSomeipDataBusServiceNotAvailable::UDSServiceFailed::2";
            }
        ...
        struct DataIdentifier_IDSSomeipDataBusServiceNotAvailable::Read::Output
        {
          ::vwg::services::diag::datatypes::fixed_size_array_with_1_uint8_items dataRecord_Count_of_services;
          ::ara::stdtypes::ByteArray dataRecord_Service_ID_Ipv6_address_Port;
          using Generated_tag = void;
          template<typename F> void visit(F& f)
          {
            f(this->dataRecord_Count_of_services);
            f(this->dataRecord_Service_ID_Ipv6_address_Port);
          }
        };

        namespace application_errors
        {
          using UDSServiceFailed = DataIdentifier_IDSSomeipDataBusServiceNotAvailable::UDSServiceFailed;
        }
