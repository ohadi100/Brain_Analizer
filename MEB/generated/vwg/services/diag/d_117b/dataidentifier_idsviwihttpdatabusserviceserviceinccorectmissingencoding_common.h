...
#ifndef VWG_SERVICES_DIAG_D_117B_DATAIDENTIFIER_IDSVIWIHTTPDATABUSSERVICESERVICEINCCORECTMISSINGENCODING_COMMON_H
#define VWG_SERVICES_DIAG_D_117B_DATAIDENTIFIER_IDSVIWIHTTPDATABUSSERVICESERVICEINCCORECTMISSINGENCODING_COMMON_H

#include "ara/com/types.h"
#include "dataidentifier_idsviwihttpdatabusserviceserviceinccorectmissingencoding_types.h"
// -- Service namespace
namespace vwg
{
  ...
  namespace services
  {
    ...
    namespace diag
    {
      ...
      namespace d_117b
      {
        ...
        class DataIdentifier_IDSViwiHttpDataBusServiceServiceInccorectMissingEncoding
        {
          public:
          static constexpr ::ara::com::ServiceIdentifierType id()
          { return ::ara::com::ServiceIdentifierType("vwg::services::diag::d_117b::DataIdentifier_IDSViwiHttpDataBusServiceServiceInccorectMissingEncoding"); }
          ...
          class UDSServiceFailed : public ::ara::com::ApplicationErrorException
          {
            ...
            {
              return "DataIdentifier_IDSViwiHttpDataBusServiceServiceInccorectMissingEncoding::UDSServiceFailed::2";
            }
        ...
        struct DataIdentifier_IDSViwiHttpDataBusServiceServiceInccorectMissingEncoding::Read::Output
        {
          ::vwg::services::diag::datatypes::fixed_size_array_with_1_uint8_items dataRecord_Count_of_services;
          ::ara::stdtypes::ByteArray dataRecord_Service_path_Method_ID_Ipv6_address_Port;
          using Generated_tag = void;
          template<typename F> void visit(F& f)
          {
            f(this->dataRecord_Count_of_services);
            f(this->dataRecord_Service_path_Method_ID_Ipv6_address_Port);
          }
        };

        namespace application_errors
        {
          using UDSServiceFailed = DataIdentifier_IDSViwiHttpDataBusServiceServiceInccorectMissingEncoding::UDSServiceFailed;
        }
