...
#ifndef VWG_SERVICES_DIAG_D_4941_DATAIDENTIFIER_INTRUSIONDETECTIONSYSTEMTIMINGETHERNETANOMALIES_COMMON_H
#define VWG_SERVICES_DIAG_D_4941_DATAIDENTIFIER_INTRUSIONDETECTIONSYSTEMTIMINGETHERNETANOMALIES_COMMON_H

#include "ara/com/types.h"
#include "dataidentifier_intrusiondetectionsystemtimingethernetanomalies_types.h"
// -- Service namespace
namespace vwg
{
  ...
  namespace services
  {
    ...
    namespace diag
    {
      ...
      namespace d_4941
      {
        ...
        class DataIdentifier_IntrusionDetectionSystemTimingEthernetAnomalies
        {
          public:
          static constexpr ::ara::com::ServiceIdentifierType id()
          { return ::ara::com::ServiceIdentifierType("vwg::services::diag::d_4941::DataIdentifier_IntrusionDetectionSystemTimingEthernetAnomalies"); }
          ...
          class UDSServiceFailed : public ::ara::com::ApplicationErrorException
          {
            ...
            {
              return "DataIdentifier_IntrusionDetectionSystemTimingEthernetAnomalies::UDSServiceFailed::2";
            }
        ...
        struct DataIdentifier_IntrusionDetectionSystemTimingEthernetAnomalies::Read::Output
        {
          ::ara::stdtypes::UInt32 dataRecord_abnormal_ethernet_sensor_id;
          ::ara::stdtypes::UInt32 dataRecord_number_of_events;
          using Generated_tag = void;
          template<typename F> void visit(F& f)
          {
            f(this->dataRecord_abnormal_ethernet_sensor_id);
            f(this->dataRecord_number_of_events);
          }
        };

        namespace application_errors
        {
          using UDSServiceFailed = DataIdentifier_IntrusionDetectionSystemTimingEthernetAnomalies::UDSServiceFailed;
        }
