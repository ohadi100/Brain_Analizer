...
#ifndef AC_DM_DATA_ELEMENT_UINT16_DATAELEMENT_UINT16_COMMON_H
#define AC_DM_DATA_ELEMENT_UINT16_DATAELEMENT_UINT16_COMMON_H

#include "ara/com/types.h"
#include "dataelement_uint16_types.h"
// -- Service namespace
namespace ac
{
  ...
  namespace dm
  {
    ...
    namespace data_element_uint16
    {
      ...
      class DataElement_uint16
      {
        public:
        static constexpr ::ara::com::ServiceIdentifierType id()
        { return ::ara::com::ServiceIdentifierType("ac::dm::data_element_uint16::DataElement_uint16"); }
      ...
      struct DataElement_uint16::Read::Output
      {
        ::autosar_platform::implementationdatatypes::uint16 dataRecord;
