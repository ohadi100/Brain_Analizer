...
#ifndef AC_DM_DATA_ELEMENT_VECTOR_UINT8_DATAELEMENT_VECTOR_UINT8_COMMON_H
#define AC_DM_DATA_ELEMENT_VECTOR_UINT8_DATAELEMENT_VECTOR_UINT8_COMMON_H

#include "ara/com/types.h"
#include "dataelement_vector_uint8_types.h"
// -- Service namespace
namespace ac
{
  ...
  namespace dm
  {
    ...
    namespace data_element_vector_uint8
    {
      ...
      class DataElement_vector_uint8
      {
        public:
        static constexpr ::ara::com::ServiceIdentifierType id()
        { return ::ara::com::ServiceIdentifierType("ac::dm::data_element_vector_uint8::DataElement_vector_uint8"); }
      ...
      struct DataElement_vector_uint8::Read::Output
      {
        ::ac::dm::types::ByteVectorType dataRecord;
