...
#ifndef AC_DM_DATA_ELEMENT_UINT8_DATAELEMENT_UINT8_SKELETON_H
#define AC_DM_DATA_ELEMENT_UINT8_DATAELEMENT_UINT8_SKELETON_H

// -- Inclusion of common header file
#include "dataelement_uint8_common.h"
  ...
  namespace dm
  {
    ...
    namespace data_element_uint8
    {
      ...
      namespace skeleton
      {
        ...
        namespace methods
        {
          using Cancel = ::ara::com::internal::skeleton::Method<::ac::dm::data_element_uint8::DataElement_uint8::Cancel>;
          using Read = ::ara::com::internal::skeleton::Method<::ac::dm::data_element_uint8::DataElement_uint8::Read>;
        }// namespace methods

        // -- Service skeleton class
        class DataElement_uint8Skeleton : public ::ara::com::internal::skeleton::Skeleton<DataElement_uint8>
        {
          public:
          // -- Creation of service skeleton
          DataElement_uint8Skeleton(
          ...
          // -- Provision of method
          using CancelOutput = ::ac::dm::data_element_uint8::DataElement_uint8::Cancel::Output;
          virtual ::ara::com::Future<CancelOutput>
          Cancel(::ac::dm::types::MetaInfoType const& metaInfo) = 0;

          using ReadOutput = ::ac::dm::data_element_uint8::DataElement_uint8::Read::Output;
