...
#ifndef AC_DM_DATA_ELEMENT_UINT32_DATAELEMENT_UINT32_COMMON_H
#define AC_DM_DATA_ELEMENT_UINT32_DATAELEMENT_UINT32_COMMON_H

#include "ara/com/types.h"
#include "dataelement_uint32_types.h"
// -- Service namespace
namespace ac
{
  ...
  namespace dm
  {
    ...
    namespace data_element_uint32
    {
      ...
      class DataElement_uint32
      {
        public:
        static constexpr ::ara::com::ServiceIdentifierType id()
        { return ::ara::com::ServiceIdentifierType("ac::dm::data_element_uint32::DataElement_uint32"); }
      ...
      struct DataElement_uint32::Read::Output
      {
        ::autosar_platform::implementationdatatypes::uint32 dataRecord;
